...
UI_TITLE = os.environ.get("UI_TITLE") or "MPES"
UI_LOGO = os.environ.get("UI_LOGO")
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO")
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Alô RH"
UI_CHAT_DESCRIPTION = (
    os.environ.get("UI_CHAT_DESCRIPTION")
    or "Esse chatbot te ajuda a tirar dúvidas sobre seus benefícios"
)
